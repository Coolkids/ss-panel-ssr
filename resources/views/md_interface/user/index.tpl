                    ...
                    <div class="card">
                        <div class="card-main">
                            <div class="card-inner">
                                {$user_index_topmsg}
                                <p>
                                    <a class="btn btn-flat collapsed waves-attach" data-toggle="collapse"
                                       href="#ui_collapse_msg">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>密码:</td>
                                                <td>
                                                    <a class="btn btn-sm collapsed waves-attach" data-toggle="collapse"
                                                       href="#ui_password_msg">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    {if $user->usedPercent()<20}
                                                        <p style="margin: auto;">使用率{$user->usedPercent()}%</p>
                                                    {/if}
                                                    <div class="progress" style="height: 20px;margin: auto">
                                                        <div class="progress-bar progress-green text-center"
                                        ...
                                        <div class="col-md-6 col-sm-6 margin-top">
                                            <div class="card">
                                                <div class="card-main">
                                                    ...
                                                    <div class="card-action">
                                                        <div class="card-action-btn pull-left">
                                                            <a class="btn btn-flat waves-attach" data-backdrop="static"
                                                               data-toggle="modal" href="#ui_dialog_node_{$node->id}">详细信息/More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<footer class="ui-footer">
    <div class="container">
        <p>Panel <a href="/user/tutorial">使用教程</a></p>
    </div>
</footer>
<div class="fbtn-container">
    <div class="fbtn-inner">
        <a class="fbtn fbtn-lg fbtn-brand-accent waves-attach waves-circle waves-light" data-toggle="dropdown"><span
                    class="fbtn-text fbtn-text-left">Links</span><span class="fbtn-ori icon">apps</span><span
                    class="fbtn-sub icon">close</span></a>
        <div class="fbtn-dropup">
            <a class="fbtn waves-attach waves-circle" href="https://github.com/lan894734188/ss-panel-ssr"
               target="_blank"><span class="fbtn-text fbtn-text-left">Fork me on GitHub</span><span
                        class="icon">code</span></a>
            <a class="fbtn fbtn-brand waves-attach waves-circle waves-light" href="http://weibo.com/347898945"
               target="_blank"><span class="fbtn-text fbtn-text-left">Follow me on Weibo</span><span
                        class="icon">share</span></a>
            <a class="fbtn fbtn-green waves-attach waves-circle" href="https://www.bydisk.com/" target="_blank"><span
                        class="fbtn-text fbtn-text-left">Visit our Website</span><span class="icon">link</span></a>
        </div>
    </div>
</div>
<!-- ===node_info==== -->
{foreach $nodes as $node}
    <div aria-hidden="true" class="modal modal-va-middle fade" id="ui_dialog_node_{$node->id}" role="dialog"
         tabindex="-3">
        <div class="modal-dialog modal-xs">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <p class="text-right"><a id="node_sugre_{$node->id}"
                                             class="btn btn-flat btn-brand-accent waves-attach">Sugre</a><a
                                id="node_ssrqrcode_{$node->id}" class="btn btn-flat btn-brand-accent waves-attach">SSR二维码</a><a
                                id="node_qrcode_{$node->id}"
                                class="btn btn-flat btn-brand-accent waves-attach">SS二维码</a><a
                                class="btn btn-flat btn-brand-accent waves-attach" data-dismiss="modal">关闭</a></p>
                </div>
...
<div aria-hidden="true" class="modal modal-va-middle fade" id="ui_dialog_passwd" role="dialog" tabindex="-3">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach"
                                         data-dismiss="modal">取消</a><a
                            class="btn btn-flat btn-brand-accent waves-attach" id="pwd-update">提交</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach"
                                         data-dismiss="modal">取消</a><a
                            class="btn btn-flat btn-brand-accent waves-attach" id="ss-pwd-update">确定</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach"
                                         data-dismiss="modal">取消</a><a
                            class="btn btn-flat btn-brand-accent waves-attach" id="method-update">确定</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach"
                                         data-dismiss="modal">取消</a><a
                            class="btn btn-flat btn-brand-accent waves-attach" id="SSRProtocol-update">确定</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach"
                                         data-dismiss="modal">取消</a><a
                            class="btn btn-flat btn-brand-accent waves-attach" id="SSRobfs-update">确定</a></p>
            </div>
        </div>
    </div>
</div>
...
<div aria-hidden="true" class="modal modal-va-middle fade" id="ui_dialog_ga" role="dialog" tabindex="-3">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-left">
                    <a class="btn btn-brand-accent btn-flat waves-attach" href="/user/gareset"><span class="icon">format_color_reset</span>&nbsp;重置</a><a
                            class="btn btn-flat waves-attach" id="ga-test"><span
                                class="icon">extension</span>&nbsp;测试</a><a class="btn btn-brand btn-flat waves-attach"
                                                                            id="ga-set"><span class="icon">perm_data_setting</span>&nbsp;设置</a>
                </p>
                <p class="text-right">
...
<div aria-hidden="true" class="modal modal-va-middle fade" id="ui_dialog_kill-account" role="dialog" tabindex="-3">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach"
                                         data-dismiss="modal">关闭</a><a
                            class="btn btn-flat btn-brand-accent waves-attach" id="kill">确定</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach"
                                         data-dismiss="modal">关闭</a><a
                            class="btn btn-flat btn-brand-accent waves-attach" id="dopasscode">确定</a></p>
            </div>
        </div>
    </div>
</div>
...
<div aria-hidden="true" class="modal modal-va-middle fade" id="ui_dialog_qrcode" role="dialog" tabindex="-2">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach" data-dismiss="modal">关闭</a>
                </p>
            </div>
        </div>
    </div>
...
<div aria-hidden="true" class="modal modal-va-middle fade" id="msg-success" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <p class="text-right"><a class="btn btn-flat btn-brand-accent waves-attach" data-dismiss="modal"
                                         id="ok-close">关闭/Discard</a></p>
            </div>
        </div>
    </div>
</div>
